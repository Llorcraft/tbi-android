...
class PipeCalculator extends BaseCalculator {
  constructor(report: ReportBase) {
    super(report, [
        ...
        /**44min*/() => this.Qkwh_min =  this.ql_min * this.l * this.Ot * (!Number(report.component.fields.unknow_surface_temp) ? 1 : Number(report.component.fields.unknow_surface_temp)) / 1000,
        /**44max*/() => this.Qkwh_max =  this.ql_max * this.l * this.Ot * (!Number(report.component.fields.unknow_surface_temp) ? 1 : Number(report.component.fields.unknow_surface_temp)) / 1000,
